...
Seelowerstra{\ss}e, 14     & \textit{Mobile:} +49 152 0640 1548 \\
...
%
\href{http://wooga.com/}{\textbf{Wooga}},
Berlin, Germany
\begin{outerlist}

\item[] \textit{Backend Developer}%
        \hfill \textbf{May 2020 to present}
\begin{innerlist}
    \item Part of the team responsible for the general backend services behind all the games in the company.
    \item Daily active users are on average over 2M, at peak traffic our applications have to handle around 100k requests per second.
    \item Technologies used for the company backend include Elixir, Phoenix, AWS, Kubernetes and Terraform.
\end{innerlist}
...
\item[] \textit{Backend Developer}%
        \hfill \textbf{June 2017 to May 2020}
\begin{innerlist}
...
\href{http://orderbird.com/}{\textbf{Orderbird}},
Berlin, Germany
\begin{outerlist}

\item[] \textit{Backend Developer}%
        \hfill \textbf{January 2017 to June 2017}
\begin{innerlist}
    \item API architect and developer for distributed systems.
    \item Technologies used in the company backend include Python, Django and Java.
\end{innerlist}
...
%
Over 8 years of professional and academic experience in Python.

Programming skills in Ruby, C/C++, Shell Script, Javascript and Go.

Experience in web frameworks Django, Rails, Flask, Sinatra and BackboneJS.

Experience with BDD, TDD and Scrum.
