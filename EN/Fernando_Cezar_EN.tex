...
\begin{innerlist}
\item API developer for whitelabel products.
\item Interesting projects include a WebDAV contacts manager and the design of a Single Sign On infrastructure.
\item Occasionaly performed pentests in the company's products.
\end{innerlist}
...
Long academic research about advanced mobile networks (mainly MANET's and DTN).
